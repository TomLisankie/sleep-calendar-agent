...
SCENARIOS: list[EvalScenario] = [
    ...
    EvalScenario(
        ...
        oracle=lambda events, reply: (
            _event_with_title(events, "run") and
            _event_with_title(events, "grocer")
        ),
        tags=["create", "batch"],
    ...
    EvalScenario(
        ...
        oracle=lambda events, reply: (
            _reply_mentions(reply, "sleep", "night", "10", "22", "pm")
        ),
        tags=["read", "sleep"],
    ...
    EvalScenario(
        ...
        oracle=lambda events, reply: (
            ...
            _event_with_title(events, "nap") and
            _reply_mentions(reply, "nap", "moved", "changed", "rescheduled", "updated", "earlier")
        ),
        tags=["update"],
    ...
    EvalScenario(
        ...
        oracle=lambda events, reply: (
            any("power nap" in e["title"].lower() for e in events)
        ),
        tags=["update"],
    ...
    EvalScenario(
        ...
        oracle=lambda events, reply: (
            not _event_with_title(events, "nap")
        ),
        tags=["delete"],
    ...
    EvalScenario(
        ...
        oracle=lambda events, reply: (
            ...
            _reply_mentions(
                reply,
                "sleep", "conflict", "wind-down", "wind down",
                "protect", "bedtime", "encroach", "overlap", "inviolable",
            )
        ),
    ...
    EvalScenario(
        ...
        oracle=lambda events, reply: (
            ...
            (lambda ws, we: (
                ...
                or _reply_mentions(
                    reply, "sleep", "conflict", "wind-down", "wind down",
                    "bedtime", "protect", "overlap",
                )
    ...
    EvalScenario(
        ...
        oracle=lambda events, reply: (
            _event_with_title(events, "breakfast") or _event_with_title(events, "meeting")
        ),
    ...
    EvalScenario(
        ...
        oracle=lambda events, reply: (
            ...
            _reply_mentions(
                reply,
                "wind", "sleep", "conflict", "bedtime", "protect",
                "routine", "relax", "overlap",
            )
        ),
